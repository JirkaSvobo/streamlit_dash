...
if page == 'Mapa':
    ...
    from_hour_morning = col2.slider('rano od', min_value=5, max_value=12)
    to_hour_morning = col2.slider('rano do', min_value=5, max_value=12)
    col2.write('Pocatecni stanice odpoledne mezi {} a {}'.format(from_hour_morning, to_hour_morning))
    query_morning = """SELECT
                         start_station_latitude as lat,
                         start_station_longitude as lon
                     FROM edinburgh_bikes
